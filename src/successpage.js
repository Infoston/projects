...
//             <h1>
//               <FontAwesomeIcon icon={faCheckCircle} size="lg" color="blue" />
//               Order Confirmed!
//             </h1>
...
//             <h2>
//               <FontAwesomeIcon icon={faTruck} size="xs" color="blue" />
//               Shipping Method
//             </h2>
...
function Address({ title }) {
  return (
    <div className="address">
      <h3>
        <FontAwesomeIcon icon={faHome} size="xs" color="blue" /> {title}
      </h3>
      <p>Name: John Doe</p>
      <p>Address: 123 Main St</p>
      <p>City: Anytown</p>
